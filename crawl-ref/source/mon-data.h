...

{
    ...
    10, MONS_HOUND, MONS_DOOM_HOUND, MH_NATURAL, 20,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 75}, {AT_CONSTRICT, AF_CRUSH, 0}, AT_NO_ATK,
      AT_NO_ATK },
    { 22, 9, 2, 0 },
